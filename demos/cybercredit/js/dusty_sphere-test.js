...
function canvasApp() {
  ...
  var theCanvas = document.getElementById("dusty_sphere");
  ...
  function init() {
    ...
    fLen = 360; //represents the distance from the viewer to z=0 depth.
    ...
    while (p != null) {
      ...
      */
      ...
      if (outsideTest||p.dead) {
        ...
        context.rect(p.projX, p.projY, m*particleRad, m*particleRad);
        context.closePath();
        context.fill();
      }
