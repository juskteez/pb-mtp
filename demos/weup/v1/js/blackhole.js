...
function blackhole(element) {
  ...
  var star = function(){
    ...
    stars.push(this);
    this.color = 'rgba(186,60,205,'+ (1 - ((this.orbital) / 600)) +')'; // Color the star white, but make it more transparent the further out it is generated
  ...
  function loop(){
    ...
    context.fillStyle = 'rgba(59,61,113,0.6)'; // somewhat clear the context, this way there will be trails behind the stars
  ...
  function init(time){
    context.fillStyle = 'rgba(59,61,113,0)';  // Initial clear of the canvas, to avoid an issue where it all gets too dark
    context.fillRect(0, 0, cw, ch);
